...
**【タスク】1枚のプレゼンテーションスライドを作成してください。**

以下の指示に従って、シンプルなスライドを作成してください：

【重要な制約】
- スライドそのものを作成してください（HTML/CSSコードを書かないでください）
- ナビゲーション要素（「次へ」「前へ」ボタンなど）は含めないでください
- インタラクティブな要素（ボタン、フォームなど）は使用しないでください
...
**【タスク】スライド${startIdx + 1}〜${endIdx}を作成してください。**

先ほど作成した骨子に基づき、**シンプルなプレゼンテーションスライド**を作成してください。
...
**【タスク】${slideCount}枚のプレゼンテーションスライドを作成してください。**

以下の指示に従って、シンプルなスライドを作成してください：

【重要な制約】
- スライドそのものを作成してください（HTML/CSSコードを書かないでください）
- ナビゲーション要素（「次へ」「前へ」ボタン、ページ送りなど）は含めないでください
- インタラクティブな要素（ボタン、フォーム、JavaScriptなど）は使用しないでください
...
- スライドタイトル: ${sizes.slideTitle || style.sizes.slideTitle}`;
  ...
  colorSection += `\n\n【色使用の原則】
  - 通常スライド（白背景）の本文: 必ず「デフォルトテキスト色（${style.colors.text}）」を使用
