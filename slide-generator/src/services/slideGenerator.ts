...
以下のJSON形式で出力してください：
{
  "title": "サービス名のみ（例: ChatGPT、Claude、Google Workspace など）",
...
## 禁止事項
- **titleに説明文・キャッチコピー・疑問文を含める**（titleはサービス名のみ）
  - ❌ NG: 「ChatGPT 5.1で何が変わった？より使いやすく、より親しみやすいAIへ」
  - ✅ OK: 「ChatGPT」
